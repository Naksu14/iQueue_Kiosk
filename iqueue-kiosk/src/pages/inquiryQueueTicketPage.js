...
const InquiryQueueTicketPage = () => {
  const { printStatus, handlePrint, handleTryAgain } = useInquiryInputInfo();
  ...
  useEffect(() => {
    ...
    const queueNumber = localStorage.getItem("queueNumber") || "OO000";
    ...
    <div className="flex flex-col items-center justify-center p-4">
      <header className="text-center">
        <div className="flex gap-2 justify-center">
          <SubHeader
            text="Your Inquiry Ticket"
            className="font-bold uppercase"
          />
        </div>
        <p className="text-gray-600 text-sm w-[500px] mx-auto">
          Present ticket at Service Office. Your number is delayed 2 mins for
          arrival.
        </p>
      </header>
...
export default InquiryQueueTicketPage;
